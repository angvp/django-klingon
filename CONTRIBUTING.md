...
3. The pull request should work for Python 3.10 through 3.14. Check the
   GitHub Actions checks on the pull request and make sure that the tests
   pass for all supported Python/Django versions.
